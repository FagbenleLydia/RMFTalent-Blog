...
const AboutInfo: React.FC = () => {
  return (
    <section className="relative overflow-hidden py-24 px-4 sm:px-6 lg:px-8 min-h-[500px]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center justify-center h-full min-h-[300px] px-4">
        <h1 className="text-[36px] sm:text-[36px] md:text-[36px] lg:text-[48px] font-bold text-gray-900 mb-4 leading-tight">
          About RMFTalents
        </h1>
        <p className="text-[14px] sm:text-[14px] md:text-[20px] text-gray-600 max-w-2xl mx-auto leading-relaxed">
