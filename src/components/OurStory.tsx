  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        {/* OUR STORY label */}
        <p className="text-purple-500 text-[14px] font-medium tracking-wide uppercase mb-2 text-center lg:text-left">
          OUR STORY
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-16 gap-6 items-start">
          ...
          <div className="flex flex-col justify-start">
            <h2 className="text-[26px] md:text-[26px] lg:text-[32px] font-bold text-gray-900 leading-tight text-center lg:text-left">
